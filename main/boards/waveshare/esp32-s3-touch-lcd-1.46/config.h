...
#define BATTERY_UPPER_RESISTOR  200.0f
#define BATTERY_LOWER_RESISTOR  100.0f
...
#define TF_CARD_PIN_NUM_D0      GPIO_NUM_16
#define TF_CARD_PIN_NUM_CMD     GPIO_NUM_17
...
#define WALLPAPER_ROOT_DIR      "/sdcard"
